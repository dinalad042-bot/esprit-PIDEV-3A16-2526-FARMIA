...
class MatiereController extends AbstractController
{
    ...
    // Catalogue visible by agricole to browse and order
    #[Route('/catalogue', name: 'catalogue')]
    #[IsGranted('ROLE_AGRICOLE')]
    public function catalogue(MatiereRepository $repo): Response
    {
        return $this->render('erp/matiere/catalogue.html.twig', [
            'matieres' => $repo->findAllOrdered(),
        ]);
    }
