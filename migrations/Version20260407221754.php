...
final class Version20260407221754 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE plante_besoin (id INT AUTO_INCREMENT NOT NULL, nom_espece VARCHAR(50) NOT NULL, frequence_arrosage INT NOT NULL, type_engrais VARCHAR(100) NOT NULL, frequence_engrais INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
