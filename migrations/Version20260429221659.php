...
final class Version20260429221659 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE erp_ligne_achat (id INT AUTO_INCREMENT NOT NULL, quantite DOUBLE PRECISION NOT NULL, prix_unitaire DOUBLE PRECISION NOT NULL, id_achat INT NOT NULL, id_matiere INT NOT NULL, INDEX IDX_17F2E914C82CC566 (id_achat), INDEX IDX_17F2E9144E89FE3A (id_matiere), UNIQUE INDEX uk_ligne_achat (id_achat, id_matiere), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE erp_ligne_vente (id INT AUTO_INCREMENT NOT NULL, quantite INT NOT NULL, prix_unitaire DOUBLE PRECISION NOT NULL, id_vente INT NOT NULL, id_produit INT NOT NULL, INDEX IDX_B9D1470E660F6B7C (id_vente), INDEX IDX_B9D1470EF7384557 (id_produit), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE erp_matiere (id_matiere INT AUTO_INCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, unite VARCHAR(50) DEFAULT \'unité\' NOT NULL, stock DOUBLE PRECISION DEFAULT 0 NOT NULL, prix_unitaire DOUBLE PRECISION DEFAULT 0 NOT NULL, seuil_critique DOUBLE PRECISION DEFAULT 0 NOT NULL, PRIMARY KEY(id_matiere)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE erp_produit (id_produit INT AUTO_INCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, prix_vente DOUBLE PRECISION DEFAULT 0 NOT NULL, stock INT DEFAULT 0 NOT NULL, PRIMARY KEY(id_produit)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE erp_recette_ingredient (id INT AUTO_INCREMENT NOT NULL, quantite DOUBLE PRECISION NOT NULL, id_produit INT NOT NULL, id_matiere INT NOT NULL, INDEX IDX_CFB418ACF7384557 (id_produit), INDEX IDX_CFB418AC4E89FE3A (id_matiere), UNIQUE INDEX uk_recette (id_produit, id_matiere), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
